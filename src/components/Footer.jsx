        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-theme">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              {!user && (
                <li>
                  <Link to="/signup" className="hover:text-brand-text transition-colors">Join Academy Membership</Link>
                </li>
              )}
              {user && (
                <li>
                  <Link to="/profile" className="hover:text-brand-text transition-colors">View Profile</Link>
                </li>
              )}
              <li>
                <Link to="/login" className="hover:text-brand-text transition-colors">Member Login</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3.5 text-sm">
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-brand-text shrink-0 mt-0.5" />
                <span className="text-theme leading-snug">{CONTACT.address}</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-4 h-4 text-brand-text shrink-0" />
                <a href={CONTACT.phoneHref} className="hover:text-brand-text transition-colors font-bold text-theme">
                  {CONTACT.phone}
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Clock className="w-4 h-4 text-brand-text shrink-0 mt-1" />
                <div>
          ...
          <div>
            ...
            <div className="relative rounded-2xl overflow-hidden border border-theme bg-surface group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-slate-50 dark:from-slate-950 via-slate-50/40 dark:via-slate-950/40 to-transparent flex flex-col justify-end p-3 space-y-1">
                <span className="text-[10px] text-brand-text font-extrabold uppercase tracking-wider">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full py-2 px-3 bg-brand hover:bg-brand-hover text-white font-bold text-xs rounded-xl flex items-center justify-center gap-1.5 transition-colors shadow-md"
                >
